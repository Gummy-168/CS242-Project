          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 h-full">
            ...
            <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2 mt-1 items-center">
                      ...
                      {task.tag && (
                        <span className="text-[10px] bg-gray-200 text-gray-600 px-2 py-0.5 rounded">{task.tag}</span>
                      )}
              ...
              {filteredPersonalTasks.length === 0 && (
                <p className="text-center text-gray-400 text-sm py-10">No tasks for this section</p>
              )}
            </div>
          </div>
        </div>
                        ...
                        <div className="flex gap-0.5">
                          {[...Array(3)].map((_, i) => (
                            <Star 
                              key={i} 
                              size={12}
                              className={`${i < task.priority ? (task.priority === 2 ? 'text-orange-400 fill-orange-400' : 'text-red-400 fill-red-400') : 'text-gray-200'}`} 
                            />
                          ))}
                        </div>
                      </td>
