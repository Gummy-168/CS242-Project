...
export default function Dashboard() {
  ...
  const processedUniversityTasks = UNIVERSITY_TASKS.filter((task) => {
  ...
  return (
    <div className="p-8 bg-[#EFEFEF] min-h-screen font-sans text-gray-800">
      ...
      <div className="grid grid-cols-12 gap-6 overflow-y-hidden">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2 mt-1 items-center">
                      <span
                        className={`text-[10px] px-2 py-0.5 rounded ${task.category === "CS232" ? "bg-purple-100 text-purple-600" : "bg-gray-100 text-gray-500"}`}
                      >
                        {task.category}
                      </span>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {MOCK_STATS.filter((s) => s.large).map((stat, i) => (
                <div
                  key={i}
                  className={`${stat.bg || "bg-green-50"} p-6 rounded-2xl flex flex-col justify-center items-center text-center`}
                >
